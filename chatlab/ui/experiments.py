...
from chatlab.token_metrics import COLOR_SCALES, DEFAULT_COLOR_SCALE, category_for
from chatlab.ui.common import failure_status
from chatlab.ui.inspection import render_lens
from chatlab.ui.panel import as_plain_text, describe_token, event_index
from chatlab.ui import runtime
from chatlab.ui import inference_timeline
...
def rerun_saved(document, expected_identifier):
    from chatlab.ui.compare import _measure_text, _tokenizer_identity, _write_reply
    from chatlab.ui.generation import automatic_reasoning_close_count, literal_prefill_count, literal_text_ranges
    from chatlab.compare import REPLY
    skip = gr.skip()
