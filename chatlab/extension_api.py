...
class TokenMenu:
    ...
    def strip_classes(self):
        from chatlab.ui.token_menu import MENU_STRIP_CLASS
    ...
    def bridges(self):
        ...
        """
        import gradio as gr
        from chatlab.ui.token_menu import MENU_BRIDGE_CLASS, menu_bridge_ids
    ...
    def offer(self, request_id, selection, *, text, candidates, verb, label, submit, actions=()):
        from chatlab.ui.token_menu import menu_markup
        return menu_markup({
